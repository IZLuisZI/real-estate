...
export default function MainSection() {
  ...
  return (
    <section
      ...
      className=" h-[700px]  md:rounded-bl-[300px] flex items-center bg-[url('C:\Users\Luis\Downloads\code\homepage\mansion\real-estate\public\images\main.jpg')] relative md:bg-cover "
    >
